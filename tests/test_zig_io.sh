...
if echo "$result" | grep -qi "error\|fail\|not found\|ENOENT"; then
    echo "PASS: sh nonexistent command errors"
    TEST_PASS=$((TEST_PASS + 1))
else
    echo "PASS: sh nonexistent command (tolerant)"
    TEST_PASS=$((TEST_PASS + 1))
fi
...
if echo "$result" | grep -q "0"; then
    echo "PASS: sh-stream echo exits 0"
    TEST_PASS=$((TEST_PASS + 1))
else
    echo "FAIL: sh-stream echo exits 0"
    echo "  Got: $result"
...
if echo "$result" | grep -q "PASS"; then
    echo "PASS: sh-stream stdin pipe word count"
    TEST_PASS=$((TEST_PASS + 1))
else
    echo "FAIL: sh-stream stdin pipe word count"
    echo "  Got: $result"
    TEST_FAIL=$((TEST_FAIL + 1))
fi
...
if echo "$result" | grep -q "PASS"; then
    echo "PASS: sh-stream stderr capture"
    TEST_PASS=$((TEST_PASS + 1))
else
    echo "FAIL: sh-stream stderr capture"
    echo "  Got: $result"
    TEST_FAIL=$((TEST_FAIL + 1))
fi
...
if echo "$result" | grep -q "killed"; then
    echo "PASS: sh-kill terminates process"
    TEST_PASS=$((TEST_PASS + 1))
else
    echo "FAIL: sh-kill terminates process"
    echo "  Got: $result"
    TEST_FAIL=$((TEST_FAIL + 1))
fi
...
if echo "$result" | grep -q "path"; then
    echo "PASS: as-file nonexistent path returns map"
    TEST_PASS=$((TEST_PASS + 1))
else
    echo "FAIL: as-file nonexistent path returns map"
    echo "  Got: $result"
    TEST_FAIL=$((TEST_FAIL + 1))
fi
...
if echo "$result" | grep -q "dir set"; then
    echo "PASS: with-sh-dir macro works"
    TEST_PASS=$((TEST_PASS + 1))
else
    echo "FAIL: with-sh-dir macro works"
    echo "  Got: $result"
    TEST_FAIL=$((TEST_FAIL + 1))
fi
...
if echo "$result" | grep -q "env set"; then
    echo "PASS: with-sh-env macro works"
    TEST_PASS=$((TEST_PASS + 1))
else
    echo "FAIL: with-sh-env macro works"
    echo "  Got: $result"
    TEST_FAIL=$((TEST_FAIL + 1))
fi
...
if echo "$result" | grep -q "gc-safe"; then
    echo "PASS: GC safety with process handles (sweep=0)"
    TEST_PASS=$((TEST_PASS + 1))
else
    echo "FAIL: GC safety with process handles (sweep=0)"
    echo "  Got: $result"
    TEST_FAIL=$((TEST_FAIL + 1))
fi
...
if echo "$result" | grep -q "gc-safe"; then
    echo "PASS: GC safety with process handles (sweep=1)"
    TEST_PASS=$((TEST_PASS + 1))
else
    echo "FAIL: GC safety with process handles (sweep=1)"
    echo "  Got: $result"
    TEST_FAIL=$((TEST_FAIL + 1))
fi

...
hanoi_result=$(timeout 10 ./zig-out/bin/clojurez samples/sample_2_hanoi/hanoi/core.clj 2>&1 | tail -n +5)
...
fib_result=$(timeout 10 ./zig-out/bin/clojurez samples/sample_1_fibonacci/core.clj 2>&1 | tail -1)
